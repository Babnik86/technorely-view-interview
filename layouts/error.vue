<template>
  <div class="container">
    <template v-if="error.statusCode === 404">
      ...
      <code><span>else if (<b>we_screwed_up</b>)</span> {<em>alert</em>(<i>"We're really sorry about that."</i>); <span>window</span>.<em>location</em> = '/';}</code>
      <center><nuxt-link to="/">Home Page</nuxt-link></center>
    </template>
